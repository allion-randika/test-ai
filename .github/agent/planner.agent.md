...
tools: ['vscode', 'execute', 'read', 'agent', 'context7/*', 'edit', 'search', 'web', 'memory', 'todo', 'linear']
---
...
4. **Plan**: Create tasks and a structured implementation plan using Linear, then output the plan.
...
- Tasks created in Linear for tracking and execution
...
- Use Linear for task creation and planning whenever available
