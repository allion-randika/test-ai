...
tools: ['read/readFile', 'agent', 'memory', 'github']
---
...
### Step 1: Create Tasks via Linear
When a user adds a prompt, create tasks in Linear. The tasks should include implementation steps, file assignments, and phase dependencies.

### Step 2: Parse Into Phases
The Linear tasks include **file assignments** for each step. Use these to determine parallelization:
...
4. Respect explicit dependencies from the tasks
...
4. **Report progress** — After each phase, update Linear task status and commit code changes to GitHub

### Step 4: Commit and Push Code
After implementation and verification, commit the completed code to the repository and push it to the GitHub remote.

### Step 5: Verify and Report
After all phases complete, verify the work hangs together and report results back to Linear and GitHub.
